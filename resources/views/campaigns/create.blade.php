        ...
        if (xhr.status === 200) {
            ...
            const interval = setInterval(() => {
                ...
                if (sent >= total) {
                    ...
                    statusMessage.innerHTML = `<div class="alert alert-success">✅ Campaign completed!</div>`;
                }
            }, 300); // simulate progress: 1 email every 300ms
        } else {
            statusMessage.innerHTML = `<div class="alert alert-danger">❌ Something Went Wrong</div>`;
        }
    };

    xhr.onerror = function () {
        statusMessage.innerHTML = `<div class="alert alert-danger">❌ Server Error</div>`;
    };
